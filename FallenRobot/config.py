class Config(object):
    ...
    MONGO_DB_URI = "mongodb+srv://itsAakashz:Aakash7@@cluster0.avfeua6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"  # Get ths value from cloud.mongodb.com
